...
export default async function CreateReview({ params }: IRouteParams) {
  ...
  return (
    <div className="mx-4 my-8 max-w-[1136px] flex-grow rounded-lg border border-yellow-500 bg-neutral-700 p-2 md:mx-10 md:p-4 lg:mx-24 lg:my-10 lg:p-10 xl:p-16">
      <div className="flex flex-col items-center justify-center border-b-2 border-yellow-500 pb-2">
        <Image
          src={movie.poster}
          alt="Movie poster"
          width={225}
